...
function start(){
    ...
    media.addImg('pag2','../src/pag2.html','chapterTwo','../media/img/chapterTwo.png','Chapter Two');
    media.addImg('pag3','../src/pag3.html','chapterThree','../media/img/chapterThree.png','Chapter Three');
    media.addImg('pag4','../src/pag4.html','epilogue','../media/img/epilogue.png','Epilogue');
    media.addImg('pag5','../src/pag5.html','aboutMe','../media/img/aboutMe.png','About Me');
