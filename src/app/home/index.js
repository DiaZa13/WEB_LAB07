...
import song from '../../media/audio/blueSky.mp3'
...
document.getElementById('chapter_one').href= 'pag2.html';
document.getElementById('chapter_one').href= 'pag3.html';
document.getElementById('chapter_one').href= 'pag4.html';


media.bckMusic('music',song);
menuAnimation();
