...
chapterOne.addEventListener('mouseover',function(){
    c1.classList.add('animate__animated');
    c1.classList.add('animate__fadeInTopLeft');
    c1.innerText = 'Chapter One';
});
chapterOne.addEventListener('mouseout',function (){
    c1.classList.remove('animate__animated');
    c1.classList.remove('animate__fadeInTopLeft');
    c1.innerText = '';
});

chapterTwo.addEventListener('mouseover',function(){
    c2.classList.add('animate__animated');
    c2.classList.add('animate__fadeInTopLeft');
    c2.innerText = 'Chapter Two';
});
chapterTwo.addEventListener('mouseout',function (){
    c2.classList.remove('animate__animated');
    c2.classList.remove('animate__fadeInTopLeft');
    c2.innerText = '';
});

chapterThree.addEventListener('mouseover',function(){
    c3.classList.add('animate__animated');
    c3.classList.add('animate__fadeInTopLeft');
    c3.innerText = 'Chapter Three';
});
chapterThree.addEventListener('mouseout',function (){
    c3.classList.remove('animate__animated');
    c3.classList.remove('animate__fadeInTopLeft');
    c3.innerText = '';
});
